...
regexes = [
    ur"s\. prec\.$",
    ur"s\. prec\. [\u0370-\u03FF\u1F00-\u1FFF]+- entries and two next entries$",
    ur"s\. prec\. [\u0370-\u03FF\u1F00-\u1FFF]+- entries; the act\., which is not used in NT =‘[^’]+’$",
    ...
    ur"[\u0370-\u03FF\u1F00-\u1FFF]+, [\u0370-\u03FF\u1F00-\u1FFF]+, [\u0370-\u03FF\u1F00-\u1FFF]+ ‘[^’]+’$",
    ur"[\u0370-\u03FF\u1F00-\u1FFF]+ ‘hint at’ [a-z. ]+$",
    ur"[\u0370-\u03FF\u1F00-\u1FFF]+ ‘[^’]+’; in non- biblical authors freq. in sense of ‘[^’]+’$",
    ur"s\. [\u0370-\u03FF\u1F00-\u1FFF]+$",
    ur"later form of [\u0370-\u03FF\u1F00-\u1FFF]+ in same sense$",
    ur"Attic form of [\u0370-\u03FF\u1F00-\u1FFF]+$",
    ur"Attic form =[\u0370-\u03FF\u1F00-\u1FFF]+, etym\. uncertain$",
    ur"assoc. w. [\u0370-\u03FF\u1F00-\u1FFF]+; ‘[^’]+’, also ‘[^’]+’$",
    ur"assoc. w. [\u0370-\u03FF\u1F00-\u1FFF]+ [a-zA-Z ]+, pl\. as in [\u0370-\u03FF\u1F00-\u1FFF]+ ‘[^’]+’$",
    ur"cp\. [\u0370-\u03FF\u1F00-\u1FFF]+$",
    ur"cp\. [\u0370-\u03FF\u1F00-\u1FFF]+ ‘[^’]+’$",
    ur"cp\. [\u0370-\u03FF\u1F00-\u1FFF]+; ‘[^’]+’$",
