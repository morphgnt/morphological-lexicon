...
MATCHES_5 = [
    ...
    (r"ευς, εως, ὁ$",                r"^n-3e",          r"^N:M$",  "5.2/M"),
    (r"ις, εως, ὁ$",                 r"^n-3e",          r"^N:M$",  "5.2/M"),
    (r"[^ε]υς, εως, ὁ$",             r"^n-3e",          r"^N:M$",  "5.2/M"),

    (r"ις, εως, ἡ$",                 r"^n-3e",          r"^N:F$",  "5.2/F"),

    (r"ι, εως, το$",                 r"^n-3e",          r"^N:N$",  "5.2/N"),

    (r"ης, ους, ὁ$",                 r"^n-3d",          r"^N:M$",  "5.3/M"),

    (r"ως, ους, ἡ$",                 r"^n-3d",          r"^N:F$",  "5.3/F"),

    (r"ος, ους, το$",                r"^n-3[bd]",       r"^N:N$",  "5.3/N"),

    (r"οι, ων, οἱ$",                 r"^n-2a",          r"^N:M$",  "6/M"),

    (r"αι, ων, αἱ$",                 r"^n-1[abc]",      r"^N:F$",  "6/F"),
    (r"εις, εων, αἱ$",               r"^n-3e",          r"^N:F$",  "6/F"),
