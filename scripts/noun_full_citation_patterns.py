...
MATCHES_5 = [
    (r"α, ας, ἡ$",                   r"^n-1[ah]$",      r"^N:F$",  "1.1/F"),

    (r"η, ης, ἡ$",                   r"^n-1[bh]$",      r"^N:F$",  "1.2/F"),
    (r"α, ης, ἡ$",                   r"^n-1c$",         r"^N:F$",  "1.2/F"),

    (r"ας, ου, ὁ$",                  r"^n-1d$",         r"^N:M$",  "2/M"),
    (r"ης, ου, ὁ$",                  r"^n-1[fh]$",      r"^N:M$",  "2/M"),
    (r"ος, ου, ὁ$",                  r"^n-2a$",         r"^N:M$",  "2/M"),
    ...
    (r(r"({V})ψ, \1πος, {art}$"),    r"^n-3a\(1\)$",    r"^N:.$",  "5.1.1"),

    (r(r"({V})ψ, \1βος, {art}$"),    r"^n-3a\(2\)$",    r"^N:.$",  "5.1.2"),

    (r(r"({V}|αρ)ξ, \1κος, {art}$"), r"^n-3b\(1\)$",    r"^N:.$",  "5.1.3"),
    (r(r"ηξ, εκος, {art}$"),         r"^n-3b\(1\)$",    r"^N:.$",  "5.1.3"),
    (r(r"η, αικος, {art}$"),         r"^n-3b\(1\)$",    r"^N:.$",  "5.1.3"),

    (r(r"({V}γ?)ξ, \1γος, {art}$"),  r"^n-3b\(2\)$",    r"^N:.$",  "5.1.4"),

    (r(r"({V})ξ, \1χος, {art}$"),    r"^n-3b\(3\)$",    r"^N:.$",  "5.1.5"),

    (r(r"({V})ρ, \1τος, {art}$"),    r"^n-3c\(6b\)$",   r"^N:.$",  "5.1.6"),
    (r(r"({V})ς, \1τος, {art}$"), r"^n-3c\((1|6[ac])\)$", r"^N:.$", "5.1.6"),
    (r(r"({V}), \1τος, {art}$"),     r"^n-3c\(6d\)$",   r"^N:.$",  "5.1.6"),
    (r(r"({V})ς, \1ντος, {art}$"),   r"^n-3c\(5a\)$",   r"^N:.$",  "5.1.6"),
    (r(r"({V}), \1κτος, {art}$"),    r"^n-3c\(6d\)$",   r"^N:.$",  "5.1.6"),
    (r(r"({V})ξ, \1κτος, {art}$"),   r"^n-3c\(1\)$",    r"^N:.$",  "5.1.6"),
    (r(r"υ, ατος, {art}$"),          r"^n-3c\(6d\)$",   r"^N:.$",  "5.1.6"),
    (r(r"ωρ, ατος, {art}$"),         r"^n-3c\(6b\)$",   r"^N:.$",  "5.1.6"),
    (r(r"μα, ατος, το$"),            r"^n-3c\(4\)$",    r"^N:N$",  "5.1.6"),
    (r(r"ης, εντος, {art}$"),        r"^n-3c\(5a\)$",   r"^N:.$",  "5.1.6"),
    (r(r"ους, οντος, {art}$"),       r"^n-3c\(5a\)$",   r"^N:.$",  "5.1.6"),
    (r(r"ων, οντος, {art}$"),        r"^n-3c\(5b\)$",   r"^N:.$",  "5.1.6"),
    (r(r"ων, ωντος, {art}$"),        r"^n-3c\(5b\)$",   r"^N:.$",  "5.1.6"),
    (r(r"οὐς, ὠτος, το$"),           r"^n-3c\(6c\)$",   r"^N:N$",  "5.1.6"),

    (r(r"({V})ς, \1δος, {art}$"),    r"^n-3c\(2\)$",    r"^N:.$",  "5.1.7"),
    (r(r"(ου)ς, οδος, {art}$"),      r"^n-3c\(2\)$",    r"^N:.$",  "5.1.7"),

    (r(r"({V})ν, \1νος, {art}$"),    r"^n-3f\(1a\)$",   r"^N:.$",  "5.1.8"),
    (r(r"(ι)ς, \1νος, {art}$"),      r"^n-3f\(1a\)$",   r"^N:.$",  "5.1.8"),
    (r(r"ων, ονος, {art}$"),         r"^n-3f\(1b\)$",   r"^N:.$",  "5.1.8"),
    (r(r"ην, ενος, {art}$"),         r"^n-3f\(1b\)$",   r"^N:.$",  "5.1.8"),
    (r(r"({V}ρ?){V}ν, \1νος, {art}$"), r"^n-3f\(1c\)$", r"^N:.$",  "5.1.8"),

    (r(r"({V})ρ, \1ρος, {art}$"),    r"^n-3f\(2a\)$",   r"^N:.$",  "5.1.9"),
    (r(r"({V})ς, \1ρος, {art}$"),    r"^n-3f\(2a\)$",   r"^N:.$",  "5.1.9"),
    (r(r"ηρ, ερος, {art}$"),         r"^n-3f\(2b\)$",   r"^N:.$",  "5.1.9"),
    (r(r"ωρ, ορος, {art}$"),         r"^n-3f\(2b\)$",   r"^N:.$",  "5.1.9"),
    (r(r"({V}ν)ηρ, \1δρος, {art}$"), r"^n-3f\(2c\)$",   r"^N:.$",  "5.1.9"),
    (r(r"({V}σ?τ)ηρ, \1ρος, {art}$"), r"^n-3f\(2c\)$",  r"^N:.$",  "5.1.9"),

    (r(r"({V})ς, \1ος, {art}$"),     r"^n-3e\(1\)$",    r"^N:.$",  "5.1.10"),
    (r(r"(ου)ς, οος, {art}$"),       r"^n-3e\(4\)$",    r"^N:.$",  "5.1.10"),
]
...
for lexeme, metadata in sorted_items(lexemes):
    ...
    if (
        ...
        for (end, cat, dodson, key) in MATCHES_5:
            if (
                full_citation and mounce_morphcat and
                re.search(end, strip_accents(full_citation)) and
                re.search(cat, mounce_morphcat) and
