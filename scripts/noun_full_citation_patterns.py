...
MATCHES_1 = [
    ...
    (r"^(\w+)ους, \1οος, ὁ$",       r"^n-3e\(4\)$",    r"^N:M$"),  # βοῦς
    ...
    (r"^(\w+)(ι|υ)ξ, \2γος, ἡ$",    r"^n-3b\(2\)$",    r"^N:F$"),
    (r"^(\w+)(ι|α)γξ, \2γγος, ἡ$",  r"^n-3b\(2\)$",    r"^N:F$"),
    (r"^(\w+)(ο)ξ, \1\2γος, ἡ$",    r"^n-3b\(2\)$",    r"^N:F$"),
    (r"^(\w+)(ι|η)ς, \2τος, ἡ$",    r"^n-3c\(1\)$",    r"^N:F$"),
    (r"^(\w+)(τη)ς, \2τος, ἡ$",     r"^n-3c\(1\)$",    r"^N:F$"),  # ὁσιότης
    (r"^(\w+)(υ)ξ, \1\2κτος, ἡ$",   r"^n-3c\(1\)$",    r"^N:F$"),  # νύξ
...
for lexeme, metadata in sorted_items(lexemes):
    ...
    if (
        ...
        for j, (end, cat, dodson) in enumerate(MATCHES_2):
            if (
                full_citation and mounce_morphcat and
                re.search(end, strip_accents(full_citation)) and
                re.search(cat, mounce_morphcat) and
